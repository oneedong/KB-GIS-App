        ...
        React.createElement("div", { style: { flex: 1, minHeight: 0, overflowY: 'auto' } },
            React.createElement("div", { style: { padding: '18px 20px 26px', maxWidth: 760, margin: '0 auto' } },
                ...
                React.createElement("div", { style: { marginTop: 20 } },
                    React.createElement("div", { style: { font: '700 11px Pretendard', color: '#a6a8ac', letterSpacing: '.06em', marginBottom: 9 } }, "\uAE30\uC0AC \uC6D0\uBB38"),
                    React.createElement("div", { style: { font: '500 14px/1.75 Pretendard', color: '#34353a', whiteSpace: 'pre-wrap' } }, sel.body)),
                React.createElement("div", { style: { display: 'flex', gap: 8, marginTop: 22 } },
                    ...
                    React.createElement("a", { href: sel.url, target: "_blank", rel: "noopener noreferrer", style: { flex: 1.6, height: 42, background: '#FFCC00', borderRadius: 11, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, font: '700 13px Pretendard', color: '#1c1d1f', textDecoration: 'none' } }, "\uAE30\uC0AC \uC804\uBB38 \uBCF4\uAE30 \u2197")),
                React.createElement("div", { style: { font: '500 11px Pretendard', color: '#b6b8bc', textAlign: 'center', marginTop: 10 } }, "\uC694\uC57D\uC740 \uCC38\uACE0\uC6A9\uC785\uB2C8\uB2E4 \u00B7 \uC804\uCCB4 \uB0B4\uC6A9\uC740 \uAE30\uC0AC \uC6D0\uBB38\uC5D0\uC11C \uD655\uC778\uD558\uC138\uC694")))));
}
// ─── App ──────────────────────────────────────────────────
function App() {
