    ...
    return (React.createElement("div", { style: { flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column', background: '#fff' } },
        ...
        React.createElement("div", { style: { flex: 1, minHeight: 0, overflowY: 'auto' } },
            React.createElement("div", { style: { padding: '18px 20px 28px', maxWidth: 760, margin: '0 auto' } },
                ...
                ((profile && (profile.ceo || profile.cio)) || cio) && (React.createElement("div", { style: { marginTop: 20 } },
                    React.createElement("div", { style: { display: 'flex', alignItems: 'baseline', gap: 8, marginBottom: 9, flexWrap: 'wrap' } },
                        ...
                        profile && profile.leadershipAsOf && React.createElement("span", { style: { font: '500 9.5px Pretendard', color: '#9a9ca0' } },
                            "\u00B7 ",
                            profile.leadershipAsOf,
                            " \uAE30\uC900")),
                    React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 8 } },
                        profile && profile.ceo && (React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: 9, border: '1px solid #ece9e2', borderRadius: 12, padding: '12px 14px' } },
                            React.createElement("span", { style: { font: '700 9.5px Pretendard', color: '#56585c', background: '#f0eee7', padding: '3px 9px', borderRadius: 6, flexShrink: 0 } }, profile.ceoTitle || '대표'),
                            React.createElement("span", { style: { font: '700 13.5px Pretendard', color: '#1c1d1f' } }, profile.ceo))),
                        cio ? (React.createElement("a", { href: cio.url && /^https?:\/\//.test(cio.url) ? cio.url : undefined, target: "_blank", rel: "noopener noreferrer", style: { display: 'block', textDecoration: 'none', color: 'inherit', border: '1px solid #ece9e2', borderRadius: 12, padding: '12px 14px', cursor: cio.url ? 'pointer' : 'default' } },
                            React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: 7, flexWrap: 'wrap' } },
                                React.createElement("span", { style: { font: '700 9.5px Pretendard', color: '#56585c', background: '#f0eee7', padding: '3px 9px', borderRadius: 6 } }, "CIO"),
                                ...
                                cio.background && React.createElement("span", { style: { font: '500 11px Pretendard', color: '#9a9ca0' } },
                                    cio.background,
                                    " \uCD9C\uC2E0"),
                                React.createElement("span", { style: { marginLeft: 'auto', font: '500 9px Pretendard', color: '#1a7a4a', background: '#e4f5ea', padding: '2px 6px', borderRadius: 4 } }, "\uB274\uC2A4 \uCD94\uCD9C")),
                            ...
                            React.createElement("div", { style: { font: '500 10px Pretendard', color: '#b6b8bc', marginTop: 5 } },
                                ...
                                " \u00B7 ",
                                cio.source,
                                cio.url ? ' · 기사 보기 ↗' : ''))) : profile && profile.cio ? (React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: 9, border: '1px solid #ece9e2', borderRadius: 12, padding: '12px 14px' } },
                            React.createElement("span", { style: { font: '700 9.5px Pretendard', color: '#56585c', background: '#f0eee7', padding: '3px 9px', borderRadius: 6, flexShrink: 0 } }, "CIO"),
                            React.createElement("span", { style: { font: '600 13px Pretendard', color: '#1c1d1f' } }, profile.cio))) : null))),
